...
int main()
{
    ...
    vector<string>question(total+1), answer(total+1);

    vector<ll>human(total+1,0), ai(total+1,0);

    ll actually_ai_but_user_answerd_human = 0;

    ll actually_human_but_user_answerd_ai = 0;
    ...
    for( int i = 1; i <= total; i++ )
    {
        ...
        cout << "\t\t\t<<<<<< Turing Test >>>>>>" << endl << endl << endl;

        cout << "\t\t\t\tQuestion --> " << i << endl << endl;

        cout << question[i] << endl << endl << endl;

        cout << "\t\t\t\t   Answer" << endl << endl;

        cout << answer[i] << endl << endl << endl << endl << endl;

        cout << "------------------------------------------------------" << endl;

        cout << "If you think the answer is given by a human    Enter 1" << endl << endl;

        cout << "If you think the answer is given by an Ai      Enter 0" << endl << endl << endl;
        ...
        if( choice == 1 )
        {
            if( human[i] == 0 )
            {
                actually_ai_but_user_answerd_human++;
            }
        }
        else if( choice == 0 )
        {
            if( ai[i] == 0 )
            {
                actually_human_but_user_answerd_ai++;
            }
        }
        else
        {
            cout << "Wrong Key Was Pressed" << endl;
    ...
    cout << "\t\t\t\tTuring Test Result" << endl << endl << endl << endl;

    cout << "Actually answered by Ai but user thought it was Human: " << actually_ai_but_user_answerd_human << endl << endl << endl;

    cout << "Actually answered by Human but user thought it was Ai: " << actually_human_but_user_answerd_ai << endl << endl << endl << endl;
